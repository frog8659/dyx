...
<link type="text/css" rel="stylesheet" href="css/public.css?t=${t:config('token.css')}" />
<link type="text/css" rel="stylesheet" href="css/iconfont.css?t=${t:config('token.css')}" />
...
<script type="text/javascript" src="js/jquery.form.min.js?t=${t:config('token.script')}"></script>
<script type="text/javascript" src="js/jquery.ajaxfileupload.js?t=${t:config('token.script')}"></script>
<script type="text/javascript" src="js/jquery.cxselect.modified.js?t=${t:config('token.script')}"></script>
