		...
		<div class="info" metr="3">
			<table cellpadding="0" cellspacing="0" class="listTb infoList nwTb">
				<tbody>
					...
					<tr>
						<th>税后月收入（元）：</th>
						<td><input type="text" name="metr.aplJobIncome" id="aplJobIncome" value="<fmt:formatNumber type="number" groupingUsed="false" value="${metr.aplJobIncome}" />" class="inp important" /></td>
					</tr>
					<tr>
						<th>现单位工作年限（年）：</th>
